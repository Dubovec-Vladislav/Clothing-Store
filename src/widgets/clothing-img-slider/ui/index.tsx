...
export const ClothingImgSlider: FC<ClothingImgSliderProps> = ({
  sliderList,
  toggleSliderActive,
  activeSlideImg,
}) => {
  const newSliderList = sliderList?.filter(
    (slideImg) => slideImg !== activeSlideImg
  ); // Remove the activeSlideImg from the list
  ...
  return (
    <section className={style.block}>
      <div className={style.body}>
        ...
        <div className={style.cross} onClick={() => toggleSliderActive(false)}>
