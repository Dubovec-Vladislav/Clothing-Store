...
export const NewsSubscription: FC = (props) => {
  ...
  useEffect(() => {
    if (formSubmitted && !isLoading) {
      // Если форма была отправлена и загрузка закончилась, то показываем на некоторое время сообщение
      ...
      <div className={style.body}>
        {isLoading ? (
          ...
          isError ? (
            ...
            <div className={style.loadingBlock}>
              <div className={style.messageText}>Спасибо за подписку!</div>
            </div>
          )
        ) : (
          <></>
        ...
        <div className={style.row}>
          <div className={style.left}>
            <div className={style.text}>
              Будьте в курсе о наших последних предложениях
            </div>
          </div>
