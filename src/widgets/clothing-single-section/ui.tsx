...
export const ClothingSingleSection: FC<ClothingSingleSectionProps> = ({
  clothId,
}) => {
  ...
  const sliderList = activeImageObject && [
    activeImageObject.previewImg,
    ...activeImageObject.images,
  ];
  ...
  return (
    <section className={style.block}>
      <div
        className={
          isSliderActive
            ? `${style.activeClothingImgSlider} ${style.clothingImgSlider}`
            : `${style.clothingImgSlider}`
        }
      >
        <ClothingImgSlider
              ...
              <div className={style.optionPart}>
                ...
                <div className={style.prices}>
                  ...
                  <div className={style.percent}>
                    {Math.round((data.price * 100) / data.prevPrice) - 100}%
                  </div>
                </div>
                ...
                <div className={style.sizes}>
                  ...
                  <SizeSelectionLine
                    sizesList={data.sizesList}
                    selectedSize={selectedSize}
                    handleSizeClick={setSelectedSize}
                  />
                </div>
                <div className={style.footer}>
                  <div className={style.counterBtn}>
                    <CartCounterBtn
                      number={numOfClothing}
                      changeNumber={changeNumOfLocalClothing}
                    />
                  </div>
                  <div className={style.btnBlock}>
                    ...
                    {isSuccessAddition && (
                      <div className={style.successAddition}>Добавлено ✔</div>
                    )}
                    <div className={style.btn} onClick={handleAddToCartClick}>
