...
export const ClothingRow: FC<ClothingRowProps> = ({
  titleText,
  endBlockLine,
  newClothing,
  topClothing,
}) => {
  const getHook = topClothing
    ? getTopSellingClothing
    : newClothing
    ? getNewClothing
    : getClothingItems;
  ...
  return (
    <section className={style.block}>
      ...
      <div className={style.body}>
        ...
        {limit < 8 && (
          <div className={style.btn} onClick={() => setLimit(limit + 4)}>
            <Button
              text={"Посмотреть ещё (4)"}
              color={"#000"}
              fill={"#fff"}
              borderFill={"#E6E6E6"}
              hoverFill={"#E6E6E6"}
